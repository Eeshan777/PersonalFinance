...
class InterestCalculator:
    def __init__(self, root):
        ...
        self.time_combobox.bind("<Return>", lambda event: self.calculate())

        # Create and place the result table
        self.columns = ("Deposit Date", "Maturity Date", "Amount Deposited", "Interest Rate", "Time of Maturity", "Maturity Amount")
        self.result_table = ttk.Treeview(root, columns=self.columns, show='headings')
        self.result_table.grid(row=5, column=0, columnspan=2, padx=10, pady=10)
    ...
    def calculate_maturity_amount(self, principal, rate, time):
    ...
    def calculate(self):
        ...
        # Validate inputs
        if not deposit_date or not money_deposited or not interest_rate or time_of_maturity == "Select Time Period":
        ...
        self.entries.append({
            ...
            'maturity_amount': self.calculate_maturity_amount(money_deposited_value, interest_rate_value, time_of_maturity_value)
        })
